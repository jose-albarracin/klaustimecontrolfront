import { b as get_store_value, c as create_ssr_component, f as add_attribute, a as subscribe, d as escape, v as validate_component } from "../../_app/immutable/chunks/index-620e69df.js";
import { u as user } from "../../_app/immutable/chunks/login-378cee40.js";
import { t as totalHoursWorked, f as fetchHour, b as fetchEmployeesHoursWeekly, d as fetchTeamHoursWeekly, e as fetchTotalEmployeesWeekly } from "../../_app/immutable/chunks/hours-d332dc1d.js";
import { l as loading, a as apiBackend } from "../../_app/immutable/chunks/general-28d8188f.js";
...
function createSubResolver(parentScopes, resolver, prop, value) {
  ...
  return _createResolver([...set2], [""], rootScopes, fallback);
}
...
function clearStacks(meta, items) {
  ...
  for (const parsed of items) {
    ...
    if (!stacks || stacks[meta.vScale.id] === void 0 || stacks[meta.vScale.id][meta.index] === void 0) {
      return;
    }
...
class PluginService {
  ...
  notify(chart, hook, args) {
    ...
    const descriptors2 = me._descriptors(chart);
...
function parseBorderRadius(bar, maxW, maxH) {
  ...
  const skip2 = parseBorderSkipped(bar);
  return {
    topLeft: skipOrLimit(skip2.top || skip2.left, o.topLeft, 0, maxR),
    topRight: skipOrLimit(skip2.top || skip2.right, o.topRight, 0, maxR),
    bottomLeft: skipOrLimit(skip2.bottom || skip2.left, o.bottomLeft, 0, maxR),
    bottomRight: skipOrLimit(skip2.bottom || skip2.right, o.bottomRight, 0, maxR)
  };
}
...
function parse(scale, input) {
  ...
  const { parser, round: round2, isoWeekday } = options;
  let value = input;
...
const Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"container md:max-w-5xl h-max px-4 mx-auto py-6"}"><div class="${"flex justify-center md:justify-start mt-12 mb-6 pb-6 border-b-[1px] border-tertiary/30"}"><h1 class="${"text-secondary text-3xl font-bold"}">Welcome, <span>${escape("")}</span> !
	...
	${!isSuperAdmin ? `<div class="${"grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-x-8 pb-6"}"><div class="${"col-span-1 md:col-span-6 lg:col-span-12 mb-4"}"><h2 class="${"text-secondary text-xl font-bold md:mb-0"}">Overview</h2></div>
			<div class="${"col-span-1 md:col-span-3 bg-white w-full flex items-center justify-center rounded-xl shadow-lg p-6 mb-4"}"><div class="${"w-4/12 lg:w-[50px] h-fit relative"}">${validate_component(ChartJS, "ChartJS").$$render(
    $$result,
    {
    ...
    {}
					...
					<div${add_attribute(
    "class",
    `absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-end select-none  ${percentageToday >= 0 && percentageToday <= 25 ? "text-carnation" : percentageToday >= 26 && percentageToday <= 50 ? "text-yellow-orange" : percentageToday >= 51 && percentageToday <= 75 ? "text-primary" : "text-jungle-green"}`,
    0
  )}><p class="${"text-[1.2rem] md:text-[0.7rem] lg:text-[0.7rem] font-bold t"}">${escape(percentageToday)}</p>
    ...
    {}
					...
					<div${add_attribute(
    "class",
    `absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-end select-none  ${percentageWeek >= 0 && percentageWeek <= 25 ? "text-carnation" : percentageWeek >= 26 && percentageWeek <= 50 ? "text-yellow-orange" : percentageWeek >= 51 && percentageWeek <= 75 ? "text-primary" : "text-jungle-green"}`,
    0
  )}><p class="${"text-[1.2rem] md:text-[0.7rem] lg:text-[0.7rem] font-bold "}">${escape(percentageWeek)}</p>
						<p class="${"text-[0.7rem] md:text-[0.4rem] lg:text-[0.4rem] pb-[0.10rem] "}">%</p></div></div>
			...
			<div class="${"col-span-1 md:col-span-3 bg-white w-full flex items-center justify-center rounded-xl shadow-lg p-6 mb-4"}"><div class="${"w-4/12 lg:w-[50px] relative"}">${validate_component(ChartJS, "ChartJS").$$render(
    $$result,
    {
    ...
    {}
					...
					<div${add_attribute(
    "class",
    `absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-end select-none ${percentageMonth >= 0 && percentageMonth <= 25 ? "text-carnation" : percentageMonth >= 26 && percentageMonth <= 50 ? "text-yellow-orange" : percentageMonth >= 51 && percentageMonth <= 75 ? "text-primary" : "text-jungle-green"}`,
    0
  )}><p class="${"text-[1.2rem] md:text-[0.7rem] lg:text-[0.7rem] font-bold "}">${escape(percentageMonth)}</p>
						<p class="${"text-[0.7rem] md:text-[0.4rem] lg:text-[0.4rem] pb-[0.10rem] "}">%</p></div></div>
    ...
    {}
					...
					<div${add_attribute(
    "class",
    `absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-end select-none ${percentageYear >= 0 && percentageYear <= 25 ? "text-carnation" : percentageYear >= 26 && percentageYear <= 50 ? "text-yellow-orange" : percentageYear >= 51 && percentageYear <= 75 ? "text-primary" : "text-jungle-green"}`,
    0
  )}><p class="${"text-[1.2rem] md:text-[0.7rem] lg:text-[0.7rem] font-bold "}">${escape(percentageYear)}</p>
		...
		<div class="${"w-full bg-white rounded-xl p-6 flex flex-col items-center justify-center mb-6 shadow-lg"}"><div class="${"w-full md:w-11/12"}"><div class="${"flex flex-col md:flex-row justify-between items-center relative"}"><h2 class="${"text-secondary text-xl font-bold mb-4 "}">My Hours</h2>
					<div class="${"flex gap-x-1 justify-end mb-4 bg-selago rounded-md w-fit p-1 "}"><button${add_attribute(
    "class",
    `select-none  rounded-md px-4 py-1 text-[0.8rem] font-semibold  ${"bg-white text-primary shadow-sm"}`,
    0
  )}>Weekly
						</button>
						<button${add_attribute(
    "class",
    `select-none  rounded-md px-4 py-1 text-[0.8rem] font-semibold  ${"text-tertiary"}`,
    0
  )}>Monthly
						</button>
						<button${add_attribute(
    ...
    0
				...
				${validate_component(ChartJS, "ChartJS").$$render(
    $$result,
    {
    ...
    {}
		...
		${$user.body.teamAdmin ? `<div class="${"w-full bg-white rounded-xl shadow-lg p-6 flex flex-col items-center justify-center mt-12 mb-6"}">
				<div class="${"w-full md:w-11/12"}"><div class="${"flex flex-col md:flex-row justify-between items-center relative"}"><h2 class="${"text-secondary text-xl font-bold text-left mb-4 "}">Team Hours</h2>
						<div class="${"flex gap-x-1 justify-end mb-4 bg-selago rounded-md w-fit p-1 "}"><button${add_attribute(
    "class",
    `select-none  rounded-md px-4 py-1 text-[0.8rem] font-semibold  ${currentDataTeam.nameData == "weeklyTeam" ? "bg-white text-primary shadow-sm" : "text-tertiary"}`,
    0
  )}>Weekly
							</button>
							<button${add_attribute(
    "class",
    `select-none  rounded-md px-4 py-1 text-[0.8rem] font-semibold  ${currentDataTeam.nameData == "monthlyTeam" ? "bg-white text-primary shadow-sm" : "text-tertiary"}`,
    0
  )}>Monthly
							</button>
							<button${add_attribute(
    "class",
    `select-none  rounded-md px-4 py-1 text-[0.8rem] font-semibold  ${currentDataTeam.nameData == "yearlyTeam" ? "bg-white text-primary shadow-sm" : "text-tertiary"}`,
    0
  )}>Yearly
							</button></div></div>
					${validate_component(ChartJsGroups, "ChartJsGroups").$$render(
    $$result,
    {
      chartID: "myHoursTeam",
      push: true,
    ...
    {}
					...
					<div class="${"flex gap-x-1 justify-end mb-4 bg-selago rounded-md w-fit p-1 "}"><button${add_attribute(
    "class",
    `select-none  rounded-md px-4 py-1 text-[0.8rem] font-semibold  ${currentDataTotalEmployees.nameData == "weeklyTotalEmployees" ? "bg-white text-primary shadow-sm" : "text-tertiary"}`,
    0
  )}>Weekly
						</button>
						<button${add_attribute(
    "class",
    `select-none  rounded-md px-4 py-1 text-[0.8rem] font-semibold  ${currentDataTotalEmployees.nameData == "monthlyTotalEmployees" ? "bg-white text-primary shadow-sm" : "text-tertiary"}`,
    0
  )}>Monthly
						</button>
						<button${add_attribute(
    "class",
    `select-none  rounded-md px-4 py-1 text-[0.8rem] font-semibold  ${currentDataTotalEmployees.nameData == "yearlyTotalEmployees" ? "bg-white text-primary shadow-sm" : "text-tertiary"}`,
    0
  )}>Yearly
						</button></div></div>
				${validate_component(ChartJsGroups, "ChartJsGroups").$$render(
