...
${`<div class="${"w-full z-50"}"><div class="${"bg-primary w-full min-h-[70px] fixed shadow-md"}">
    ...
    return `<li class="${"pb-4"}"><a class="${escape(
      ...
      true
    ) + " svelte-1krymwh"}"${add_attribute("href", item.to, 0)}><div class="${"flex ml-6 mr-4 items-center justify-center w-[30px]"}">${validate_component(Inline_svg, "InlineSVG").$$render(
      $$result,
      {
