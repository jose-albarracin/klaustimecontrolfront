import { g as getContext, c as create_ssr_component, a as subscribe, b as get_store_value, v as validate_component, e as each, d as escape, n as null_to_empty, f as add_attribute } from "../../_app/immutable/chunks/index-620e69df.js";
import { I as Inline_svg } from "../../_app/immutable/chunks/inline-svg-6543f82a.js";
import { c as countMyHours, a as countTeamHours } from "../../_app/immutable/chunks/hours-d332dc1d.js";
import { u as user, s as setStorageUser } from "../../_app/immutable/chunks/login-378cee40.js";
...
const css = {
  code: "svg.svelte-g0wp0t.svelte-g0wp0t{min-height:24px;transition:transform 0.3s ease-in-out}svg.svelte-g0wp0t line.svelte-g0wp0t{stroke:currentColor;stroke-width:3;transition:transform 0.3s ease-in-out}button.svelte-g0wp0t.svelte-g0wp0t{z-index:20}.open.svelte-g0wp0t svg.svelte-g0wp0t{transform:scale(0.7)}.open.svelte-g0wp0t #top.svelte-g0wp0t{transform:translate(6px, 0px) rotate(45deg)}.open.svelte-g0wp0t #middle.svelte-g0wp0t{opacity:0}.open.svelte-g0wp0t #bottom.svelte-g0wp0t{transform:translate(-12px, 9px) rotate(-45deg)}aside.svelte-g0wp0t.svelte-g0wp0t{left:-100%;transition:left 0.3s ease-in-out}.openA.svelte-g0wp0t.svelte-g0wp0t{left:0}",
  map: null
};
...
${`<div class="${"w-full z-50"}"><div class="${"bg-primary w-full min-h-[70px] fixed shadow-md"}">
			<a class="${"absolute -translate-y-1/2 top-1/2 -translate-x-1/2 left-1/2"}" href="${"/"}">${validate_component(Inline_svg, "InlineSVG").$$render(
    $$result,
    {
    ...
    {}
			...
			<button class="${[
    "text-white cursor-pointer mr-4 border-none focus:outline-none absolute -translate-y-1/2 top-1/2 -translate-x-1/2 left-[10%] svelte-g0wp0t",
    ""
  ].join(" ").trim()}"><svg width="${"32"}" height="${"24"}" class="${"svelte-g0wp0t"}"><line id="${"top"}" x1="${"0"}" y1="${"2"}" x2="${"32"}" y2="${"2"}" class="${"svelte-g0wp0t"}"></line><line id="${"middle"}" x1="${"0"}" y1="${"12"}" x2="${"24"}" y2="${"12"}" class="${"svelte-g0wp0t"}"></line><line id="${"bottom"}" x1="${"0"}" y1="${"22"}" x2="${"32"}" y2="${"22"}" class="${"svelte-g0wp0t"}"></line></svg></button>
    ...
    {}
		...
		<aside class="${[
    "fixed w-10/12 bg-white border-r-2 shadow-lg h-[calc(100%-70px)] bottom-0  svelte-g0wp0t",
    ""
  ].join(" ").trim()}"><nav class="${"py-12 px-4 sm:px-6"}"><ul>${each(menu, (item) => {
    return `<li class="${"pb-4"}"><a class="${escape(
      null_to_empty(`flex items-center rounded-md py-2  ${urlParam1 === item.to ? "text-primary bg-selago border-l-[3px] border-primary" : "text-tertiary border-l-[3px] border-transparent"}`),
      true
    ) + " svelte-g0wp0t"}"${add_attribute("href", item.to, 0)}><div class="${"flex ml-6 mr-4 items-center justify-center w-[30px]"}">${validate_component(Inline_svg, "InlineSVG").$$render(
      $$result,
      {
  ...
  do {
    ...
    $$rendered = `<div class="${"bg-selago w-full h-[100vh]"}">${`<div class="${"container mx-auto flex justify-center items-center h-full px-6"}"><div class="${"bg-white rounded-xl w-full sm:w-[25rem] h-[30rem] flex flex-col justify-center items-center align-middle shadow-lg"}"><div class="${"flex justify-center mt-6"}"><a href="${"/"}">${validate_component(Inline_svg, "InlineSVG").$$render(
      ...
      {}
					...
					<div class="${"flex flex-col w-full p-6"}">${validate_component(Inputs, "Inputs").$$render(
      $$result,
      {
        class: "mb-4",
      ...
      {}
						...
						<div class="${"flex gap-x-3"}"><button class="${"bg-red-600 hover:bg-red-700 w-1/2 text-white font-bold py-2 px-4 rounded-lg flex items-center justify-center my-3"}" type="${"submit"}">${validate_component(Inline_svg, "InlineSVG").$$render(
      $$result,
      {
      ...
      {}
							...
							<button class="${"bg-blue-600 hover:bg-blue-700 w-1/2 text-white font-bold py-2 px-4 rounded-lg flex items-center justify-center my-3"}" type="${"submit"}">${validate_component(Inline_svg, "InlineSVG").$$render(
      $$result,
      {
        class: " w-[15px] h-[15px] drop-shadow-lg",
...
const _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div id="${"app"}" class="${"flex overflow-hidden"}">
	${$loading ? `<div class="${"absolute z-30 w-full h-full bg-white/80 flex justify-center items-center"}">${validate_component(Inline_svg, "InlineSVG").$$render(
    $$result,
    {
