...
const U5Bidu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
	...
	<div class="${"w-full bg-white rounded-xl p-6 shadow-lg mb-6"}"><form class="${"grid grid-cols-1 md:grid-cols-12 gap-x-8"}"><div class="${"col-span-1 md:col-span-6 mb-4"}">${validate_component(Inputs, "Inputs").$$render($$result, {
      class: "mb-4",
      label: "Employee",
      select: true,
      multiselect: null,
