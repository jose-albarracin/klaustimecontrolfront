...
const HoursEmployee = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    stateHour = Object.assign(stateHour, __spreadValues({}, isTask && { task: isTask._id }));
	...
	<div class="${"w-full bg-white rounded-xl p-6 mb-6 shadow-lg"}">${isTask ? `<form class="${"grid grid-cols-1 md:grid-cols-12 gap-x-8"}"><div class="${"col-span-1 md:col-span-6"}">${validate_component(Inputs, "Inputs").$$render($$result, {
      class: "mb-4",
      label: "Start",
      name: "start",
      type: "number",
...
export { HoursEmployee as default };
