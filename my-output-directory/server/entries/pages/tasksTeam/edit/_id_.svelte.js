...
const U5Bidu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="${"container md:max-w-5xl px-4 mx-auto shadow-sm"}"><div class="${"flex justify-start my-12 pb-6 border-b-[1px] border-tertiary/30"}"><a href="${"/tasksTeam"}" class="${"flex items-center justify-center cursor-pointer"}">${validate_component(Inline_svg, "InlineSVG").$$render($$result, {
	...
	<div class="${"w-full bg-white rounded-xl p-6"}"><form class="${"grid grid-cols-1 md:grid-cols-12 gap-x-8"}"><div class="${"col-span-1 md:col-span-12"}">${validate_component(Inputs, "Inputs").$$render($$result, {
      class: "mb-4",
      label: "Title",
      name: "title",
      type: "text",
